"""
Compare main_5 inplane_butterflies output against wood's reference.
Usage: cd session_data && python compare_inplane_butterflies.py
Wood reference: ref_inplane_butterflies.xml
Our output:     WoodF2F_inplane_butterflies.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_inplane_butterflies.pb_coords.txt"
WOOD_XML    = "ref_inplane_butterflies.xml"
TOL         = 0.5  # mm
