"""
Compare main_5 hexbox_and_corner output against wood's reference.
Usage: cd session_data && python compare_hexbox_and_corner.py
Wood reference: ref_hexbox_and_corner.xml
Our output:     WoodF2F_hexbox_and_corner.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_hexbox_and_corner.pb_coords.txt"
WOOD_XML    = "ref_hexbox_and_corner.xml"
TOL         = 0.5  # mm
