"""
Compare main_5 cross_corners output against wood's reference.
Usage: cd session_data && python compare_cross_corners.py
Wood reference: ref_cross_corners.xml
Our output:     WoodF2F_cross_corners.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_cross_corners.pb_coords.txt"
WOOD_XML    = "ref_cross_corners.xml"
TOL         = 0.5  # mm
