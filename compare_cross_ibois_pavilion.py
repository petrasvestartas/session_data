"""
Compare main_5 cross_ibois_pavilion output against wood's reference.
Usage: cd session_data && python compare_cross_ibois_pavilion.py
Wood reference: ref_cross_ibois_pavilion.xml
Our output:     WoodF2F_cross_ibois_pavilion.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_cross_ibois_pavilion.pb_coords.txt"
WOOD_XML    = "ref_cross_ibois_pavilion.xml"
TOL         = 0.5  # mm
