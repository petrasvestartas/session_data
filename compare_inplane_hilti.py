"""
Compare main_5 inplane_hilti output against wood's reference.
Usage: cd session_data && python compare_inplane_hilti.py
Wood reference: ref_inplane_hilti.xml
Our output:     WoodF2F_inplane_hilti.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_inplane_hilti.pb_coords.txt"
WOOD_XML    = "ref_inplane_hilti.xml"
TOL         = 0.5  # mm
