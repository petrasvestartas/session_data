"""
Compare main_5 vda_floor_2 output against wood's reference.
Usage: cd session_data && python compare_vda_floor_2.py
Wood reference: ref_vda_floor_2.xml
Our output:     WoodF2F_vda_floor_2.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_vda_floor_2.pb_coords.txt"
WOOD_XML    = "ref_vda_floor_2.xml"
TOL         = 0.5  # mm
