"""
Compare main_5 outofplane_dodecahedron output against wood's reference.
Usage: cd session_data && python compare_outofplane_dodecahedron.py
Wood reference: ref_outofplane_dodecahedron.xml
Our output:     WoodF2F_outofplane_dodecahedron.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_outofplane_dodecahedron.pb_coords.txt"
WOOD_XML    = "ref_outofplane_dodecahedron.xml"
TOL         = 0.5  # mm
