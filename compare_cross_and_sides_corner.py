"""
Compare main_5 cross_and_sides_corner output against wood's reference.
Usage: cd session_data && python compare_cross_and_sides_corner.py
Wood reference: ref_cross_and_sides_corner.xml
Our output:     WoodF2F_cross_and_sides_corner.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_cross_and_sides_corner.pb_coords.txt"
WOOD_XML    = "ref_cross_and_sides_corner.xml"
TOL         = 0.5  # mm
