"""
Compare main_5 cross_vda_hexshell output against wood's reference.
Usage: cd session_data && python compare_cross_vda_hexshell.py
Wood reference: ref_cross_vda_hexshell.xml
Our output:     WoodF2F_cross_vda_hexshell.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_cross_vda_hexshell.pb_coords.txt"
WOOD_XML    = "ref_cross_vda_hexshell.xml"
TOL         = 0.5  # mm
