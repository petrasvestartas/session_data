...
COORDS_FILE = "WoodF2F_vidy_full.pb_coords.txt"
WOOD_XML    = "ref_vidy_full.xml"
TOL         = 0.5  # mm
...
if len(our) != len(wood_ref):
    print("ELEMENT COUNT MISMATCH — check that out.xml is the vidy_full reference (84 groups)")
