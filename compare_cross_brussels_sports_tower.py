"""
Compare main_5 cross_brussels_sports_tower output against wood's reference.
Usage: cd session_data && python compare_cross_brussels_sports_tower.py
Wood reference: ref_cross_brussels_sports_tower.xml
Our output:     WoodF2F_cross_brussels_sports_tower.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_cross_brussels_sports_tower.pb_coords.txt"
WOOD_XML    = "ref_cross_brussels_sports_tower.xml"
TOL         = 0.5  # mm
