"""
Compare main_5 cross_square_reciprocal_two_sides output against wood's reference.
Usage: cd session_data && python compare_cross_square_reciprocal_two_sides.py
Wood reference: ref_cross_square_reciprocal_two_sides.xml
Our output:     WoodF2F_cross_square_reciprocal_two_sides.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_cross_square_reciprocal_two_sides.pb_coords.txt"
WOOD_XML    = "ref_cross_square_reciprocal_two_sides.xml"
TOL         = 0.5  # mm
