"""
Compare main_5 annen_box output against wood's reference.
Usage: cd session_data && python compare_annen_box.py
Wood reference: ref_annen_box.xml
Our output:     WoodF2F_annen_box.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_annen_box.pb_coords.txt"
WOOD_XML    = "ref_annen_box.xml"
TOL         = 0.5  # mm
