"""
Compare main_5 hexboxes output against wood's reference.
Usage: cd session_data && python compare_hexboxes.py
Wood reference: ref_hexboxes.xml
Our output:     WoodF2F_hexboxes.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_hexboxes.pb_coords.txt"
WOOD_XML    = "ref_hexboxes.xml"
TOL         = 0.5  # mm
