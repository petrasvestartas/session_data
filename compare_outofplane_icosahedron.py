"""
Compare main_5 outofplane_icosahedron output against wood's reference.
Usage: cd session_data && python compare_outofplane_icosahedron.py
Wood reference: ref_outofplane_icosahedron.xml
Our output:     WoodF2F_outofplane_icosahedron.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_outofplane_icosahedron.pb_coords.txt"
WOOD_XML    = "ref_outofplane_icosahedron.xml"
TOL         = 0.5  # mm
