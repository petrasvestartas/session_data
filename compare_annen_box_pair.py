"""
Compare main_5 annen_box_pair output against wood's reference.
Usage: cd session_data && python compare_annen_box_pair.py
Wood reference: ref_annen_box_pair.xml
Our output:     WoodF2F_annen_box_pair.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_annen_box_pair.pb_coords.txt"
WOOD_XML    = "ref_annen_box_pair.xml"
TOL         = 0.5  # mm
