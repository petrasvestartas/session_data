"""
Compare main_5 hex_block_rossiniere output against wood's reference.
Usage: cd session_data && python compare_hex_block_rossiniere.py
Wood reference: ref_hex_block_rossiniere.xml
Our output:     WoodF2F_hex_block_rossiniere.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_hex_block_rossiniere.pb_coords.txt"
WOOD_XML    = "ref_hex_block_rossiniere.xml"
TOL         = 0.5  # mm
