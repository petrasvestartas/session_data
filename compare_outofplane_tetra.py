"""
Compare main_5 outofplane_tetra output against wood's reference.
Usage: cd session_data && python compare_outofplane_tetra.py
Wood reference: ref_outofplane_tetra.xml
Our output:     WoodF2F_outofplane_tetra.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_outofplane_tetra.pb_coords.txt"
WOOD_XML    = "ref_outofplane_tetra.xml"
TOL         = 0.5  # mm
