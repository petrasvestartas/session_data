"""
Compare main_5 vidy_folding output against wood's reference.
Usage: cd session_data && python compare_vidy_folding.py
Wood reference: ref_vidy_folding.xml
Our output:     WoodF2F_vidy_folding.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_vidy_folding.pb_coords.txt"
WOOD_XML    = "ref_vidy_folding.xml"
TOL         = 0.5  # mm
