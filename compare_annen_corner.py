"""
Compare main_5 annen_corner output against wood's reference.
Usage: cd session_data && python compare_annen_corner.py
Wood reference: ref_annen_corner.xml
Our output:     WoodF2F_annen_corner.pb_coords.txt
"""
import xml.etree.ElementTree as ET
import os, math

COORDS_FILE = "WoodF2F_annen_corner.pb_coords.txt"
WOOD_XML    = "ref_annen_corner.xml"
TOL         = 0.5  # mm
